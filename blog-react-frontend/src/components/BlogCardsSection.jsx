...
import Cards from './Cards'; // Assuming Cards component is defined correctly
...
export default function BlogSection(props) {
  ...
  function filterByCategory(blog) {
    return !selCat || blog.category === selCat;
  }

  // Filter blogs by category and paginate based on currentPage and pageSize
  const filteredBlogs = staticBlogData
  ...
  return (
    <div className="grid md:grid-cols-3 sm:grid-cols-2 px-10 w-full">
      {filteredBlogs.map((blog, index) => (
        <Cards key={blog.id} card_data={blog} />
      ))}
    </div>
  );
}
